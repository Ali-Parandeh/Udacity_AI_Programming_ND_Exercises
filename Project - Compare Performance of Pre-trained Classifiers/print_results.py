...
def print_results(results_dic, results_stats_dic, model, 
    ...
    """    
    print("\nThe model used for this classification is '{}'.".format(model))
        ...
        for image in results_dic:
            if sum(results_dic[image][3:]) == 1:
                if count:
                    ...
                    count = 0
                print("Pet Image: {:>30}   classifier label: {:>30}".format(results_dic[image][0], results_dic[image][1]))
        ...
        for image in results_dic:
            if sum(results_dic[image][3:]) == 2 and results_dic[image][2] == 0:
                if count:
                    ...
                    count = 0
                print("Pet Image: {:>30}   classifier label: {:>26}".format(results_dic[image][0], results_dic[image][1]))
