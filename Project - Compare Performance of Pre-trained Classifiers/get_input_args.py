...
# Check https://docs.python.org/3/library/argparse.html for usage of this module
...
def get_input_args():
    ...
    parser = argparse.ArgumentParser(description = "Process the command line arguments provided by the user")
    # Create 3 command line arguments as mentioned above using add_argument() from ArguementParser method
    parser.add_argument("--dir", type = str, default = "pet_images/", help = "path to the folder of pet images" )
    parser.add_argument("--arch", type = str, default = "vgg", help = "Type of CNN Model Architecture to use" )
    parser.add_argument("--dogfile", type = str, default = "dognames.txt", help = "path to the text file with Dog Names" )
    # Replace None with parser.parse_args() parsed argument collection that 
    # you created with this function  This converts argument strings to objects and assign them as attributes of the namespace. Return the populated namespace.
